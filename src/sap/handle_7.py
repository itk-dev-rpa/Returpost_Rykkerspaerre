...
def extend_all_rykkerspaerrer_deadlines(session, row_indices):
    ...
    for row in row_indices:
        ...
        type_ = session.findById("wnd[0]/usr/subBDT_AREA:SAPLBUSS:0021/tabsBDT_TABSTRIP01/tabpBUSCR02_01/ssubGENSUB:SAPLBUSS:0029/ssubGENSUB:SAPLBUSS:7135/subA04P02:SAPLFMCA_PSOB_BDT2:0330/ctxtSPSOB_SCR_2110_H3-DUNN_REASON").text
        if type_ and type_ != '7':
            raise ValueError(f"Rykkerspæretype is not '7': '{type_}'")
